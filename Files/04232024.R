...
file.copy(paste0(ssc_location,"/", "exception report.xlsx"), 
          paste0(exception_report_destination, "/", "exception report 2024.04.23.xlsx"), 
          overwrite = TRUE)
...
file.copy(paste0(ssc_location,"/", "Inventory.xlsx"), 
          paste0("S:/Supply Chain Projects/Data Source (SCE)/Inventory/Inventory with Lot Report v.2 - 2024.04.23.xlsx"), 
          overwrite = TRUE)

# JDE 25,55
file.copy(paste0(ssc_location,"/", "JDE 25,55.xlsx"), 
          paste0("S:/Supply Chain Projects/Data Source (SCE)/Inventory/JDE Inventory Lot Detail - 2024.04.23.xlsx"), 
          overwrite = TRUE)
...
# SS Metrics
file.copy(paste0(ssc_location,"/", "SS Metrics 0423.xlsx"), 
          paste0(destination, "/", "SS Metrics 0423.xlsx"), 
          overwrite = TRUE)


# Weekly Safety Stock Compliance Report
file.copy(paste0(ssc_location,"/", "Weekly Safety Stock Compliance Report v4 rolling 53 weeks - 04.23.2024.xlsb"), 
          paste0(destination, "/", "Weekly Safety Stock Compliance Report v4 rolling 53 weeks - 04.23.2024.xlsb"), 
          overwrite = TRUE)
