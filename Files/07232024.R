...
dir.create("S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/07232024", showWarnings = FALSE)
dir.create("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/07.23.2024", showWarnings = FALSE)
dir.create("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/2024/07.23.2024", showWarnings = FALSE)
dir.create("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/DNRR Automation/DNRR Weekly Report/2024/07.23.2024", showWarnings = FALSE)
dir.create("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/2024/07.23.2024", showWarnings = FALSE)
dir.create("C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2024/07.23.2024", showWarnings = FALSE)

######################################################################################################################

ssc_location <- "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/Safety Stock Compliance/Weekly Run Files/2024/07.23.2024"
bom_location <- "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/BoM version 2/Weekly Run/2024/07.23.2024"
dnrr_location <- "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/DNRR Automation/DNRR Weekly Report/2024/07.23.2024"
iqr_rm_location <- "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/RM/Weekly Report run/2024/07.23.2024"
iqr_fg_location <- "C:/Users/slee/OneDrive - Ventura Foods/Ventura Work/SCE/Project/FY 23/IQR Automation/FG/weekly run data/2024/07.23.2024"

destination <- "S:/Supply Chain Projects/Data Source (SCE)/Report ingredients/Stan/07232024"
...
# PO JDE
file.copy(paste0(ssc_location,"/", "Copy of PO Reporting Tool - 07.23.24.xlsx"), 
...
file.copy(paste0(ssc_location,"/", "Weekly Safety Stock Compliance Report v4 rolling 53 weeks - 07.23.2024.xlsb"), 
          paste0(destination, "/", "Weekly Safety Stock Compliance Report v4 rolling 53 weeks - 07.23.2024.xlsb"), 
          overwrite = TRUE)
...
file.copy(paste0(dnrr_location,"/", "Sales and Open Orders Cube - Date Range - 3 months.xlsx"), 
          paste0(destination, "/", "Sales and Open Orders Cube - Date Range - 3 months 07.23.2024.xlsx"), 
          overwrite = TRUE)
...
# DNRR Tool ver.3
file.copy(paste0(dnrr_location,"/", "DNRR Tool ver.3 - 07.23.2024.xlsx"), 
          paste0(destination, "/", "DNRR Tool ver.3 - 07.23.2024.xlsx"), 
          overwrite = TRUE)
...
# Result
file.copy(paste0(iqr_fg_location,"/", "iqr_fg_rstudio_07232024.xlsx"), 
          paste0(destination, "/", "iqr_fg_rstudio_07232024.xlsx"), 
          overwrite = TRUE)
